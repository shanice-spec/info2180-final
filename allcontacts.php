                            ...
                            <div id="results">
                                ...
                                <?php } ?>
                                        ...
                                        <?php if($result["type"]=="Sales Leads"){?>
                                            <td id="issue-button"><button style="cursor: default;" id="open">Sales Leads</button></td>
                                        <?php } ?>
                                        <?php if($result["type"]=="Support"){?>
                                            <td id="issue-button"><button style="cursor: default;" id="closed">Support</button></td>
                                        <?php } ?>
